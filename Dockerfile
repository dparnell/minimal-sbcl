...
# Install sbcl 1.3.4
RUN cd /tmp && curl -O http://tenet.dl.sourceforge.net/project/sbcl/sbcl/1.3.4/sbcl-1.3.4-source.tar.bz2 && tar jxvf sbcl-1.3.4-source.tar.bz2 && cd /tmp/sbcl-1.3.4 && sh ./make.sh  && sh ./install.sh && rm -rf /tmp/sbcl*
